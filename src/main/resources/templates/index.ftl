                ...
                <div class="card-body">
                  <nav>
                    <div class="nav nav-tabs nav-fill" id="nav-tab" role="tablist">
                      <a class="nav-item nav-link active" id="nav-home-tab" data-toggle="tab" href="#nav-ing" role="tab" aria-controls="nav-ing" aria-selected="true">진행중 <label class="badge badge-danger">1</label></a>
                      <a class="nav-item nav-link" id="nav-profile-tab" data-toggle="tab" href="#nav-wait" role="tab" aria-controls="nav-wait" aria-selected="false">대기 <label class="badge badge-warning">2</label></a>
                      <a class="nav-item nav-link" id="nav-contact-tab" data-toggle="tab" href="#nav-end" role="tab" aria-controls="nav-end" aria-selected="false">완료 <label class="badge badge-success">5</label></a>
                    </div>
                  </nav>
                  <div class="tab-content py-3 px-3 px-sm-0" id="nav-tabContent">
                    <div class="tab-pane fade show active" id="nav-ing" role="tabpanel" aria-labelledby="nav-ing-tab">
                      <div class="col-md-12 mb-4">
                        <button class="btn btn-outline-dark w-100" data-toggle="modal" data-target="#addModal"><i class="ti-plus"></i></button>
                      </div>
                      <div class="col-md-12 p-1 ingListDiv" data-toggle="modal" data-target="#addModal">
                        <div class="col-md-12 stretch-card transparent">
                          <div class="card card-outline-primary">
                            <div class="card-body">
                              <div class="d-flex justify-content-between">
                                <p class="card-title"><i class="ti-arrow-right"></i> Example Lable 1</p>
                              </div>
                              <p>Sub 1</p>
                              <p>Sub 2</p>
                            </div>
